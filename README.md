...
| **Tests** | [@web/test-runner](https://modern-web.dev/docs/test-runner/overview/) in real Chrome, with [axe-core](https://github.com/dequelabs/axe-core) accessibility assertions — 308 tests |
